...
class ToolsControllerTest < ActionController::TestCase
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post :create, tool: { as_int: @tool.as_int, description: @tool.description, measure_unit: @tool.measure_unit, qty: @tool.qty, title: @tool.title }
    end
  ...
  test "should update tool" do
    patch :update, id: @tool, tool: { as_int: @tool.as_int, description: @tool.description, measure_unit: @tool.measure_unit, qty: @tool.qty, title: @tool.title }
    assert_redirected_to tool_path(assigns(:tool))
  end
