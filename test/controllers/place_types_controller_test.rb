...
class PlaceTypesControllerTest < ActionController::TestCase
  ...
  test "should create place_type" do
    assert_difference('PlaceType.count') do
      post :create, place_type: { common: @place_type.common, description: @place_type.description, restricted: @place_type.restricted, title: @place_type.title }
    end
  ...
  test "should update place_type" do
    patch :update, id: @place_type, place_type: { common: @place_type.common, description: @place_type.description, restricted: @place_type.restricted, title: @place_type.title }
    assert_redirected_to place_type_path(assigns(:place_type))
  end
