...
class TaskTypesControllerTest < ActionController::TestCase
  ...
  test "should create task_type" do
    assert_difference('TaskType.count') do
      post :create, task_type: { description: @task_type.description, each_n_weeks: @task_type.each_n_weeks, title: @task_type.title, week_days: @task_type.week_days }
    end
  ...
  test "should update task_type" do
    patch :update, id: @task_type, task_type: { description: @task_type.description, each_n_weeks: @task_type.each_n_weeks, title: @task_type.title, week_days: @task_type.week_days }
    assert_redirected_to task_type_path(assigns(:task_type))
  end
